...
type Props = {
    ...
    onChangeTab?: (tab: "tokens" | "activity") => void;
    children: ReactNode;
};

export default function PortfolioLayout({ active, onChangeTab, children }: Props) {
            ...
            <div className="home-container">
                ...
                <div className="rounded-[32px] border bg-linear-to-r from-primary/20 via-primary/10 to-transparent px-8 py-10 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-6 max-w-md">
                        See your BCH and CashToken balances, recent swaps, pool creations, and
                        liquidity changes in one place.
                    </p>
    ...
    return (
        <div className="home-container">
            ...
            <PortfolioTabs active={active} onChange={onChangeTab} />
            {children}
        </div>
    );
}
