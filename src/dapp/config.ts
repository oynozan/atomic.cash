...
export const NETWORK: Network = networkEnv === "mainnet" ? Network.MAINNET : Network.CHIPNET;

export const NETWORK_STRING: string = NETWORK === Network.MAINNET ? "mainnet" : "chipnet";
